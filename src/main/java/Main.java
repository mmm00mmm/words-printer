...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> words = Arrays.asList(args[0].split(" "));
...
//        List<String> list = Arrays.asList("this book is so funny".split(" "));
//
//        Capitalize capitalize = new Capitalize(list);
//        System.out.println(capitalize.各単語の先頭1文字を大文字にする());
//
//        Reverse reverse = new Reverse(list);
//        System.out.println(reverse.単語の順番を逆にする());
//
//        Compress compress = new Compress(list);
//        System.out.println(compress.各単語の中の連続する文字を1文字にする());
//
//        Horizontal horizontal = new Horizontal(words);
//        horizontal.単語を半角スペースで区切って出力する();
//
